...
class TestGroup {
    ...
    fun testCreateGroup() {
        ...
        assertTrue(group.members.contains(student1))
        assertTrue(group.members.contains(student2))
    ...
    fun testCreateGroupErrorBusyMember() {
        ...
        val group1 = Group("group1", arrayOf(student))
    ...
    fun testRemoveMeeting() {
        ...
        assertEquals(1, group.meetings.size)
        assertEquals(meeting, group.meetings[0])
        group.removeMeeting(meeting)
        assertEquals(0, group.meetings.size)
    }
}